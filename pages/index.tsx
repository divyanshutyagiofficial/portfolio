              ...
              <div className="inner-container">
                    ...
                    <ul>
                      ...
                      <li className="npm">
                        ...
                        <a
                          ...
                          href="https://www.npmjs.com/~dunks1980"
                        >
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width={80}
                ...
                <main className="projects-overview">
                  <div className="main-message">
                    <div className="welcome-message">
                      ...
                      <span>
                        <p>
                          ...
                          systems for well know products and clients from
                          real-time Chat applications, E-commerce platforms, to
                    ...
                    >
                      ...
                      <span>
                        <p>
                          ...
                          homework, chores and exercise and convert it into
                          screen time. I created this with Vue.js and the Howlr
                          libary to add the interactive clock sounds. It can be
                          installed as a progressive web application and is also
                          available from the google play store. The git
                          repository for this one is private at the moment.{" "}
                        </p>{" "}
                        <button>
                          {" "}
                          <a
                    ...
                    <div
                      className="individual-project"
                      data-link="https://domposer.com"
                    >
                      <h2>Domposer</h2>{" "}
                      <span>
                        <p>
                          Domposer is a website builder which has a UI that
                          allows you to quickly add and rearrange HTML and CSS,
                        ...
                        <button>
                          {" "}
                          <a target="_blank" href="https://domposer.com">
                            {" "}
                            View Site{" "}
                          </a>{" "}
                        </button>
                    ...
                    <div
                      className="individual-project"
                      data-link="https://cookiemunch.dunks1980.com"
                    >
                      <h2>Cookiemunch</h2>{" "}
                      <span>
                        <p>
                          A simple, customizable, minimal setup cookie plugin
                          that allows your users to select which cookies to
                          accept or decline. This was created with vanilla JS,
                          SCSS and Parcel Bundler and is available as a NPM
                          package and the git repository makes any type of
                        ...
                        <button>
                          ...
                          <a
                            target="_blank"
                            href="https://cookiemunch.dunks1980.com"
                          >
                            {" "}
                            View Site{" "}
                          </a>{" "}
                        ...
                        <button>
                          ...
                          <a
                            rel="noopener"
                            target="_blank"
                            href="https://github.com/Dunks1980/Cookiemunch"
                          >
                            Github{" "}
                          </a>{" "}
                        </button>{" "}
                        <button>
                          ...
                          <a
                            rel="noopener"
                            target="_blank"
                            href="https://www.npmjs.com/package/@dunks1980/cookiemunch"
                          >
                            {" "}
                            NPM{" "}
                          </a>{" "}
                      ...
                      <span>
                        ...
                        <button>
                          ...
                          <a
                            rel="noopener"
                            target="_blank"
                            href="https://github.com/Dunks1980/bay.js"
                          >
                            {" "}
                            Github{" "}
                          </a>{" "}
                        ...
                        <button>
                          ...
                          <a
                            rel="noopener"
                            target="_blank"
                            href="https://www.npmjs.com/package/@dunks1980/bay.js"
                          >
                            {" "}
                            NPM{" "}
                          </a>{" "}
                    ...
                    <div
                      className="individual-project"
                      data-link="https://dro.carematix.com/#/002/abc233/welcome"
                    >
                      <h2>DRO</h2>{" "}
                      <span>
                        <p>
                        ...
                        <button>
                          ...
                          <a
                            rel="noopener"
                            target="_blank"
                            href="https://inlinesvg.dunks1980.com/"
                          >
                            {" "}
                            View Site{" "}
                          </a>{" "}
                        ...
                        <button>
                          ...
                          <a
                            rel="noopener"
                            target="_blank"
                            href="https://github.com/Dunks1980/inline.svg"
                          >
                            Github{" "}
                          </a>{" "}
                        </button>{" "}
                        <button>
                          ...
                          <a
                            rel="noopener"
                            target="_blank"
                            href="https://www.npmjs.com/package/@dunks1980/inline.svg"
                          >
                            {" "}
                            NPM{" "}
                          </a>{" "}
