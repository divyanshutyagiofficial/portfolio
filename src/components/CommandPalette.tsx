...
export function CommandPalette({ open, onOpenChange }: Props) {
  ...
  const commands: Command[] = useMemo(() => {
    ...
    return [
      ...
      { id: "dl-resume", label: "Download polyglot resume (JSON)", hint: "Node · .NET · React/Next/Angular", group: "Action", icon: Download, perform: open("/resumes/divyanshu-tyagi-polyglot.json") },
      { id: "print-resume", label: "Print resume → PDF", hint: "/resume?print=1", group: "Action", icon: Download, perform: goto("/resume/?print=1") },
